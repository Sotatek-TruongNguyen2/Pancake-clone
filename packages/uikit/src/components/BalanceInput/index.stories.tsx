...
export const SwitchUnits: React.FC<React.PropsWithChildren> = () => {
  const CAKE_PRICE = 69;
  const [editingUnit, setEditingUnit] = useState<"NIKA" | "USD">("NIKA");
  const conversionUnit = editingUnit === "NIKA" ? "USD" : "NIKA";
  ...
  const switchEditingUnits = () => {
    const editingUnitAfterChange = editingUnit === "NIKA" ? "USD" : "NIKA";
