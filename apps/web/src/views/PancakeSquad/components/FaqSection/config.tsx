...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Nika Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Nika Bunny NFTs at the snapshot may also purchase one additional Nika Squad NFT in the presale for each Nika Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of NIKA spent on Nika Squad NFTs will be burned as part of our weekly NIKA burn.')],
  },
  {
