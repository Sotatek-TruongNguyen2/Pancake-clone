...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and NIKA pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and NIKA pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from NIKA pool', data)
  }
