...
const ContributeModal: React.FC<React.PropsWithChildren<Props>> = ({
  ...
  const label = currency === bscTokens.cake ? t('Max. NIKA entry') : t('Max. token entry')
        ...
        <Box p="2px">
          ...
          <Flex justifyContent="space-between" mb="8px">
            ...
            <Flex flexGrow={1} justifyContent="flex-end">
              <Image
                src={
                  ifo.currency.symbol === 'NIKA'
                    ? '/images/nika-token.png'
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough NIKA, you may not receive a meaningful amount of IFO tokens, or you may not receive any IFO tokens at all.',
            )}
