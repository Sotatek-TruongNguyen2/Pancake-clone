...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        NIKA up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale has
        no participation fee.
      </Trans>,
      <Trans>
        In the Public Sale, everyone with an active NikaSwap profile can commit. However the maximum amount of NIKA
        users can commit, is equal to the number of iNIKA they have.
      </Trans>,
      <>
        <Trans>Learn more about iNIKA</Trans>
        <InlineLink ml="4px" href="">
          <Trans>here</Trans>
        </InlineLink>
      </>,
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active NikaSwap Profile in order to participate.</Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The NIKA from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of NIKA to either sale.</Trans>,
      <Trans>
