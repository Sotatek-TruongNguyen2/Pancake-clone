...
export const DEFAULT_META: PageMeta = {
  title: 'Tiktak Code',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Tiktak Code), NFTs, and more, on a platform you can trust.',
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for Tiktak Code exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for Tiktak Code exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Tiktak Code exchanges.' },
      '/nfts/collections': { basePath: true, title: t('Collections') },
      '/nfts/activity': { title: t('Activity') },
      '/profile': { basePath: true, title: t('Profile') },
      '/pancake-squad': { basePath: true, title: t('Tiktak Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('Tiktak Code'),
  }
}
