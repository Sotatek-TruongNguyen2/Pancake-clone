...
export const DEFAULT_META: PageMeta = {
  title: 'NikaSwap',
  description:
    'The most popular AMM on BSC by user count! Earn NIKA through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by NikaSwap), NFTs, and more, on a platform you can trust.',
  image: '/logo.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for NikaSwap exchanges.' },
      '/info/pairs': { title: t('Pairs'), description: 'View statistics for NikaSwap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for NikaSwap exchanges.' },
      '/nfts/collections': { basePath: true, title: t('Collections') },
      '/nfts/activity': { title: t('Activity') },
      '/profile': { basePath: true, title: t('Profile') },
      '/pancake-squad': { basePath: true, title: t('Nika Squad') },
      '/pottery': { basePath: true, title: t('Pottery') },
    },
    defaultTitleSuffix: t('NikaSwap'),
  }
}
